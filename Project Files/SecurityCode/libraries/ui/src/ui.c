...
///////////////////// FUNCTIONS ////////////////////
void ui_update_InputField()
{
    lv_obj_set_style_text_color(ui_Text_input, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
{
    _ui_label_set_property(ui_Text_input, _UI_LABEL_PROPERTY_TEXT, text);
}

void ui_edit_color(lv_color_t color)
{
    lv_obj_set_style_text_color(ui_Text_input, color, LV_PART_MAIN | LV_STATE_DEFAULT );
}
void resetScreen()
{
